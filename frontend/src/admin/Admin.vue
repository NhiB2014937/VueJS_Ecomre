            ...
            <form id="adminForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="Nhập mật khẩu của quản lý" v-model="adminObj.pass" />
                </div>

                <div class="form-group">
                    <input type="submit" value="Đăng nhập quản lý" class="btn">
                </div>
            </form>
        </div>
    </div>
    ...
    methods: {
        ...
        handleSubmit(e) {
            ...
            if (!this.adminObj.pass) {
                this.errors.push('Yêu cầu nhập mật khẩu');
            }
