            ...
            <form id="loginForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="Nhập mật khẩu" v-model="loginObj.pass" />
                </div>

                <div class="form-group">
                    <input type="submit" value="Đăng nhập" class="btn">
                    <p>Chưa có tài khoản? <router-link @click="scrollToTop()" to="/register">Đăng ký ngay!
                        </router-link>
                    </p>
                </div>
            </form>
    ...
    methods: {
        ...
        async handleSubmit(e) {
            ...
            if (!this.loginObj.email) {
                this.errors.push("Chưa nhập email");
            }
            else {
            ...
            if (!this.loginObj.pass) {
                this.errors.push('Nhập mật khẩu');
            }
            ...
            if (!this.errors.length == 0) {
                ...
                if (!this.matchUser) {
                    this.errors.push("Sai email hoặc mật khẩu!")
                }
                else {
