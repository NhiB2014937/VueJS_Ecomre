        ...
        checkForm: function () {
            ...
            if (!this.registerObj.name) {
                ...
                if (!/^[A-Za-z]+$/.test(this.registerObj.name.replace(/\s/g, ""))) {
                    this.errorObj.nameErr.push('Tên chỉ được chứa kí tự A-Z hoặc a-z');
                }
            }
            ...
            if (!this.registerObj.phone) {
                ...
                if (!this.registerObj.phone.startsWith('84')) {
                    this.errorObj.phoneErr.push('SĐT phải bắt đầu bằng 84');
                }

                if (this.registerObj.phone.length != 11) {
                    this.errorObj.phoneErr.push('SĐT phải có 11 chữ số');
                }
            ...
            if (!this.registerObj.gender) {
                this.errorObj.genderErr.push("Làm ơn chọn giới tính");
            }
        },
