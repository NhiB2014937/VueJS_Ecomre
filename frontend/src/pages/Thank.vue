<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Cảm ơn đã đặt niềm tin vào Hemtrachanh</p>
            <p v-none>
                Hem đã xác nhận đơn của bạn, và mong bạn hài lòng.
                Mọi món ăn, thức uống đều được làm một các tậm tâm đến từng chi tiết để
                khách hành như bạn có một trải nghiệm tốt nhất.
            </p>
            <router-link class="btn" to="/menu">Tiếp tục mua</router-link>
        </div>
    </div>
</template>
