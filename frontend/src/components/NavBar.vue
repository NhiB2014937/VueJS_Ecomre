<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />Hemtrachanh
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">home</router-link>
            <router-link @click="scrollToTop()" to="/about">giới thiệu</router-link>
            <router-link @click="scrollToTop()" to="/promotions">khuyến mãi</router-link>
